...
(function (global, factory) {
    ...
    brush.move = function (group, selection) {
      if (group.selection) {
        ...
        group.each(function () {
          ...
          interrupt(that);
          state.selection =
            selection1 == null || empty(selection1) ? null : selection1;
          redraw.call(that);
  ...
  function circle() {
    ...
    circle.center = function (_) {
      return arguments.length
        ? ((center = typeof _ === "function" ? _ : constant$7([+_[0], +_[1]])),
          circle)
        : center;
    };
  ...
  function identity$5() {
    ...
    return (projection = {
      ...
      scale: function (_) {
        return arguments.length
          ? ((transform$$1 = scaleTranslate((k = +_) * sx, k * sy, tx, ty)),
            reset())
          : k;
      },
  ...
  function index$3() {
    ...
    treemap.paddingInner = function (x) {
      return arguments.length
        ? ((paddingInner = typeof x === "function" ? x : constant$8(+x)),
          treemap)
        : paddingInner;
    };
    ...
    treemap.paddingRight = function (x) {
      return arguments.length
        ? ((paddingRight = typeof x === "function" ? x : constant$8(+x)),
          treemap)
        : paddingRight;
    };
    ...
    treemap.paddingBottom = function (x) {
      return arguments.length
        ? ((paddingBottom = typeof x === "function" ? x : constant$8(+x)),
          treemap)
        : paddingBottom;
    };
    ...
    treemap.paddingLeft = function (x) {
      return arguments.length
        ? ((paddingLeft = typeof x === "function" ? x : constant$8(+x)),
          treemap)
        : paddingLeft;
    };
  ...
  function continuous(deinterpolate, reinterpolate) {
    ...
    scale.domain = function (_) {
      return arguments.length
        ? ((domain = map$3.call(_, number$2)), rescale())
        : domain.slice();
    };
  ...
  function identity$6() {
    ...
    scale.domain = scale.range = function (_) {
      return arguments.length
        ? ((domain = map$3.call(_, number$2)), scale)
        : domain.slice();
    };
  ...
  var hour = newInterval(
    function (date) {
      var offset =
        (date.getTimezoneOffset() * durationMinute$1) % durationHour$1;
      if (offset < 0) offset += durationHour$1;
      date.setTime(
        Math.floor((+date - offset) / durationHour$1) * durationHour$1 + offset,
      );
    },
    function (date, step) {
  ...
  function arc() {
    ...
    arc.padRadius = function (_) {
      return arguments.length
        ? ((padRadius =
            _ == null ? null : typeof _ === "function" ? _ : constant$10(+_)),
          arc)
        : padRadius;
    };
  ...
  function area$2() {
    ...
    area.x = function (_) {
      return arguments.length
        ? ((x0 = typeof _ === "function" ? _ : constant$10(+_)),
          (x1 = null),
          area)
        : x0;
    };
    ...
    area.x0 = function (_) {
      return arguments.length
        ? ((x0 = typeof _ === "function" ? _ : constant$10(+_)), area)
        : x0;
    };
    ...
    area.y = function (_) {
      return arguments.length
        ? ((y0 = typeof _ === "function" ? _ : constant$10(+_)),
          (y1 = null),
          area)
        : y0;
    };
    ...
    area.y0 = function (_) {
      return arguments.length
        ? ((y0 = typeof _ === "function" ? _ : constant$10(+_)), area)
        : y0;
    };
  ...
  function stack() {
    ...
    stack.keys = function (_) {
      return arguments.length
        ? ((keys = typeof _ === "function" ? _ : constant$10(slice$6.call(_))),
          stack)
        : keys;
    };
